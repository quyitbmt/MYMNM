                        ...
                        if (isset($_POST['s-product'])) {
                            if ($_POST['s-product'] != ''){
                                ...
                                switch($_GET['filter_price']){
                                    ...
                                    break;
                                    case "2":
                                        $sql="select * FROM tbl_product WHERE name like $s  and price between 100000 and 200000 order by id asc limit $trang,8";   
                                    break;
                                    case "3":
                                        $sql="select * FROM tbl_product WHERE name like $s  and price between 200000 and 300000 order by id asc limit $trang,8";   
                                    break;
                                    case "4":
                                        $sql="select * FROM tbl_product WHERE name like $s and price between 300000 and 400000 order by id asc limit $trang,8";   
                                    break;
                                    case "5":
                                        $sql="select * FROM tbl_product WHERE name like $s and price price >= 500000 order by id asc limit $trang,8";   
                                    break;
                                    default:
                            ...
                            switch($_POST['filter_price']){
                                case "1":
                                    $sql="select * FROM tbl_product WHERE  price between 0 and 100000 order by id asc limit $trang,8"; 
                                break;
                                case "2":
                                    $sql="select * FROM tbl_product WHERE  price between 100000 and 200000 order by id asc limit $trang,8";   
                                break;
                                case "3":
                                    $sql="select * FROM tbl_product WHERE  price between 200000 and 300000 order by id asc limit $trang,8";   
                                break;
                                case "4":
                                    $sql="select * FROM tbl_product WHERE  price between 300000 and 400000 order by id asc limit $trang,8";   
                                break;
                                case "5":
                                    $sql="select * FROM tbl_product WHERE  price >= 500000 order by id asc limit $trang,8";   
                                break;
                                default:
